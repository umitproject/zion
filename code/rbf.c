               ...
               const unsigned int number_of_centers)
{
    ...
    r->output = malloc(sizeof(clann_type) * output_size);
    r->centers_width = malloc(sizeof(clann_type) * number_of_centers);
                            ...
                            const struct matrix *d)
{
    ...
    clann_type v, c[r->centers.cols], e = 0;
