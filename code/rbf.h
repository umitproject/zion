...
struct rbf
{
    ...
    clann_type *output;
    clann_type *centers_width;
    clann_type desired_error;
    clann_type learning_rate_centers;
    clann_type learning_rate_weights;
    clann_type learning_rate_spreads;
    clann_type noticeable_change_rate;
};
