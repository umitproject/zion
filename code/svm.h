...
struct svm
{
    ...
    clann_type output;
    clann_type *weights;
    clann_type *multipliers;
    clann_type **support_vectors;
    clann_type punishment_factor;

    clann_type rbf_width;
    clann_type mlp_kappa;
    clann_type mlp_vartheta;
    clann_type poly_order;
