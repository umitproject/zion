...
euclidean(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_euclidean(x->values, y->values, x->cols);
...
norm(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_norm(x->values, x->cols);
...
dot_product(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_dot_product(x->values, y->values, x->cols);
...
hausdorff(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff(x, y);
...
hausdorff_symmetric(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_symmetric(x, y);
...
hausdorff_limit(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_limit(x, y, limit);
...
hausdorff_limit_symmetric(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_limit_symmetric(x, y, limit);
...
hausdorff_mean(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_mean(x, y);
...
hausdorff_mean_symmetric(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_mean_symmetric(x, y);
...
hausdorff_angle(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_angle(x, y, limit);
...
hausdorff_angle_symmetric(PyObject *self, PyObject *args)
{
    ...
    clann_type v = metric_hausdorff_angle_symmetric(x, y, limit);
